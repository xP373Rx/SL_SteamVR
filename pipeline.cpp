...
//START P373R
bool LLPipeline::EnableSteamVR;
bool LLPipeline::EnableSmoothing;
bool LLPipeline::DistortionApplied;
F32 LLPipeline::EyeDistance;
S32 LLPipeline::TextureShift;
//END P373R
...
// [/SL:KB]
	...
	//START P373R
	connectRefreshCachedSettingsSafe("EnableSteamVR");
	connectRefreshCachedSettingsSafe("EnableSmoothing");
	connectRefreshCachedSettingsSafe("DistortionApplied");
	connectRefreshCachedSettingsSafe("EyeDistance");
	connectRefreshCachedSettingsSafe("TextureShift");
	//END P373R
	//<FS:TS> FIRE-16251: Depth of Field does not work underwater
...
// [/SL:KB]
	...
	//START P373R
	EnableSteamVR = gSavedSettings.getBOOL("EnableSteamVR");
	EnableSmoothing = gSavedSettings.getBOOL("EnableSmoothing");
	DistortionApplied = gSavedSettings.getBOOL("DistortionApplied");
	EyeDistance = gSavedSettings.getF32("EyeDistance");
	TextureShift = gSavedSettings.getS32("TextureShift");
	//END P373R
	//<FS:TS> FIRE-16251: Depth of Field does not work underwater
